...
object RetrofitClient {
    // 🌐 选择你的环境
    private const val BASE_URL = "http://13.229.148.21:8090/api/v1/"  // ✅ 生产环境
...
```bash
# 测试开始行程
curl -X POST http://13.229.148.21:8090/api/v1/mobile/trips/start \
...
// 生产环境
private const val BASE_URL = "http://13.229.148.21:8090/api/v1/"
```
